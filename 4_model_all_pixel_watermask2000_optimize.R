...
setwd("K:/baihao/UHI/2025/all_pixel_watermask2000")
output <- "./figs_full"
log_path <- "log.txt"
...
#save
write_lines(pass_list,'./all_model_results/pass_list_allpixel_watermask2000.txt')
write_csv(result_all,'./all_model_results/result_all_allpixel_watermask2000.csv')
write_csv(result_pars,'./all_model_results/result_pars_allpixel_watermask2000.csv')
